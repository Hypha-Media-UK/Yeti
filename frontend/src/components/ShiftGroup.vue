    ...
    <div v-else class="shift-list">
      ...
      <div v-if="getAllocatedStaff(assignments).length > 0" class="allocated-staff-container">
        <div
          ...
          :title="'Temporarily allocated to department/service • ' + getStaffItemTitle(assignment)"
        >
          <span class="staff-name">
            {{ assignment.staff.firstName }} {{ assignment.staff.lastName }}
          </span>
...
// Get allocated staff (present only, staff who have been temporarily allocated to departments/services)
